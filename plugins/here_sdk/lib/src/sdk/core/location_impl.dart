...
class Location {
  ...
  ///
  @Deprecated('Will be removed in v4.9.0. To create a new Location instance use one of the available named constructors.')
  ...
  Location.withAllFields(this.coordinates, this.timestamp, {this.bearingInDegrees, this.speedInMetersPerSecond,
    this.horizontalAccuracyInMeters, this.verticalAccuracyInMeters, this.bearingAccuracyInDegrees,
    this.speedAccuracyInMetersPerSecond, this.timestampSinceBootInMilliseconds});
  ...
  Location.withDefaults(GeoCoordinates coordinates, DateTime timestamp)
    : coordinates = coordinates, bearingInDegrees = null, speedInMetersPerSecond = null, timestamp = timestamp,
    horizontalAccuracyInMeters = null, verticalAccuracyInMeters = null, this.bearingAccuracyInDegrees = null,
    this.speedAccuracyInMetersPerSecond = null, this.timestampSinceBootInMilliseconds = null;

...
class LocationConverter  {
  ...
  static Location convertFromInternal(Location_internal internalLocation) =>
  ...
  static Location_internal convertToInternal(Location location) =>
    Location_internal(location.coordinates,

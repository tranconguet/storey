...
final _sdk_mapview_MapViewBase_PickMapItemsCallback_copy_handle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapViewBase_PickMapItemsCallback_copy_handle'));
final _sdk_mapview_MapViewBase_PickMapItemsCallback_release_handle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapViewBase_PickMapItemsCallback_release_handle'));
final _sdk_mapview_MapViewBase_PickMapItemsCallback_create_proxy = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
class MapViewBasePickMapItemsCallback$Impl {
  ...
  call(PickMapItemsResult p0) {
    final _call_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_mapview_MapViewBase_PickMapItemsCallback_call__PickMapItemsResult'));
...
final _sdk_mapview_MapViewBase_PickMapItemsCallback_create_handle_nullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapViewBase_PickMapItemsCallback_create_handle_nullable'));
final _sdk_mapview_MapViewBase_PickMapItemsCallback_release_handle_nullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapViewBase_PickMapItemsCallback_release_handle_nullable'));
final _sdk_mapview_MapViewBase_PickMapItemsCallback_get_value_nullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
...
final _sdk_mapview_MapViewBase_copy_handle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapViewBase_copy_handle'));
final _sdk_mapview_MapViewBase_release_handle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_mapview_MapViewBase_release_handle'));
final _sdk_mapview_MapViewBase_create_proxy = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Uint64, Int32, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer),
    Pointer<Void> Function(int, int, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer, Pointer)
  >('here_sdk_sdk_mapview_MapViewBase_create_proxy'));
final _sdk_mapview_MapViewBase_get_type_id = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
...
class MapViewBase$Impl implements MapViewBase {
  ...
  @override
  addLifecycleListener(MapViewLifecycleListener lifecycleListener) {
    final _addLifecycleListener_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_mapview_MapViewBase_addLifecycleListener__MapViewLifecycleListener'));
    final _lifecycleListener_handle = sdk_mapview_MapViewLifecycleListener_toFfi(lifecycleListener);
    final _handle = this.handle;
    final __result_handle = _addLifecycleListener_ffi(_handle, __lib.LibraryContext.isolateId, _lifecycleListener_handle);
    sdk_mapview_MapViewLifecycleListener_releaseFfiHandle(_lifecycleListener_handle);
    try {
      return (__result_handle);
    } finally {
      (__result_handle);
  ...
  @override
  removeLifecycleListener(MapViewLifecycleListener lifecycleListener) {
    final _removeLifecycleListener_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>)>('here_sdk_sdk_mapview_MapViewBase_removeLifecycleListener__MapViewLifecycleListener'));
    final _lifecycleListener_handle = sdk_mapview_MapViewLifecycleListener_toFfi(lifecycleListener);
    final _handle = this.handle;
    final __result_handle = _removeLifecycleListener_ffi(_handle, __lib.LibraryContext.isolateId, _lifecycleListener_handle);
    sdk_mapview_MapViewLifecycleListener_releaseFfiHandle(_lifecycleListener_handle);
    try {
      return (__result_handle);
    } finally {
  ...
  /// Gets the viewport size in physical pixels.
  Size2D get viewportSize {
    final _get_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Pointer<Void>, Int32), Pointer<Void> Function(Pointer<Void>, int)>('here_sdk_sdk_mapview_MapViewBase_viewportSize_get'));
    final _handle = this.handle;
    final __result_handle = _get_ffi(_handle, __lib.LibraryContext.isolateId);
    try {
      return sdk_core_Size2D_fromFfi(__result_handle);
    } finally {
      sdk_core_Size2D_releaseFfiHandle(__result_handle);
    }
  }
...
int _MapViewBase_addLifecycleListener_static(int _token, Pointer<Void> lifecycleListener) {

  try {
    (__lib.instanceCache[_token] as MapViewBase).addLifecycleListener(sdk_mapview_MapViewLifecycleListener_fromFfi(lifecycleListener));
  } finally {
    sdk_mapview_MapViewLifecycleListener_releaseFfiHandle(lifecycleListener);
  }
  return 0;
}
int _MapViewBase_removeLifecycleListener_static(int _token, Pointer<Void> lifecycleListener) {

  try {
    (__lib.instanceCache[_token] as MapViewBase).removeLifecycleListener(sdk_mapview_MapViewLifecycleListener_fromFfi(lifecycleListener));
  } finally {
    sdk_mapview_MapViewLifecycleListener_releaseFfiHandle(lifecycleListener);
  }
  return 0;
...
int _MapViewBase_viewportSize_get_static(int _token, Pointer<Pointer<Void>> _result) {
  _result.value = sdk_core_Size2D_toFfi((__lib.instanceCache[_token] as MapViewBase).viewportSize);
  return 0;
}
...
Pointer<Void> sdk_mapview_MapViewBase_toFfi(MapViewBase value) {
  ...
  final result = _sdk_mapview_MapViewBase_create_proxy(
    ...
    Pointer.fromFunction<Uint8 Function(Uint64, Pointer<Void>)>(_MapViewBase_addLifecycleListener_static, __lib.unknownError),
    Pointer.fromFunction<Uint8 Function(Uint64, Pointer<Void>)>(_MapViewBase_removeLifecycleListener_static, __lib.unknownError),
    ...
    Pointer.fromFunction<Uint8 Function(Uint64, Pointer<Pointer<Void>>)>(_MapViewBase_viewportSize_get_static, __lib.unknownError),

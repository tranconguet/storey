...
class Details {
  ...
  List<PlaceCategory> getPrimaryCategories() {
    final _getPrimaryCategories_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Pointer<Void>, Int32), Pointer<Void> Function(Pointer<Void>, int)>('here_sdk_sdk_search_Details_getPrimaryCategories'));
...
final _sdk_search_Details_EvChargingStation_create_handle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>)
  >('here_sdk_sdk_search_Details_EvChargingStation_create_handle'));
final _sdk_search_Details_EvChargingStation_release_handle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_EvChargingStation_release_handle'));
final _sdk_search_Details_EvChargingStation_get_field_connectors = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_EvChargingStation_get_field_connectors'));
final _sdk_search_Details_EvChargingStation_get_field_connectorCount = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_EvChargingStation_get_field_connectorCount'));

Pointer<Void> sdk_search_Details_EvChargingStation_toFfi(DetailsEvChargingStation value) {
  final _connectors_handle = heresdk_search_common_bindings_ListOf_sdk_search_EvConnector_toFfi(value.internalconnectors);
  final _connectorCount_handle = Int_toFfi_nullable(value.internalconnectorCount);
  final _result = _sdk_search_Details_EvChargingStation_create_handle(_connectors_handle, _connectorCount_handle);
  heresdk_search_common_bindings_ListOf_sdk_search_EvConnector_releaseFfiHandle(_connectors_handle);
  Int_releaseFfiHandle_nullable(_connectorCount_handle);
  return _result;
}

DetailsEvChargingStation sdk_search_Details_EvChargingStation_fromFfi(Pointer<Void> handle) {
  final _connectors_handle = _sdk_search_Details_EvChargingStation_get_field_connectors(handle);
  final _connectorCount_handle = _sdk_search_Details_EvChargingStation_get_field_connectorCount(handle);
  try {
    return DetailsEvChargingStation(
      heresdk_search_common_bindings_ListOf_sdk_search_EvConnector_fromFfi(_connectors_handle), 
...
void sdk_search_Details_EvChargingStation_releaseFfiHandle(Pointer<Void> handle) => _sdk_search_Details_EvChargingStation_release_handle(handle);

// Nullable DetailsEvChargingStation

final _sdk_search_Details_EvChargingStation_create_handle_nullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_EvChargingStation_create_handle_nullable'));
final _sdk_search_Details_EvChargingStation_release_handle_nullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_EvChargingStation_release_handle_nullable'));
final _sdk_search_Details_EvChargingStation_get_value_nullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_EvChargingStation_get_value_nullable'));

Pointer<Void> sdk_search_Details_EvChargingStation_toFfi_nullable(DetailsEvChargingStation value) {
  if (value == null) return Pointer<Void>.fromAddress(0);
  final _handle = sdk_search_Details_EvChargingStation_toFfi(value);
  final result = _sdk_search_Details_EvChargingStation_create_handle_nullable(_handle);
  sdk_search_Details_EvChargingStation_releaseFfiHandle(_handle);
  return result;
}

DetailsEvChargingStation sdk_search_Details_EvChargingStation_fromFfi_nullable(Pointer<Void> handle) {
  if (handle.address == 0) return null;
  final _handle = _sdk_search_Details_EvChargingStation_get_value_nullable(handle);
  final result = sdk_search_Details_EvChargingStation_fromFfi(_handle);
  sdk_search_Details_EvChargingStation_releaseFfiHandle(_handle);
  return result;
}

void sdk_search_Details_EvChargingStation_releaseFfiHandle_nullable(Pointer<Void> handle) =>
  _sdk_search_Details_EvChargingStation_release_handle_nullable(handle);

// End of DetailsEvChargingStation "private" section.

// Details "private" section, not exported.

final _sdk_search_Details_create_handle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
final _sdk_search_Details_release_handle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_release_handle'));
final _sdk_search_Details_get_field_contacts = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_get_field_contacts'));
final _sdk_search_Details_get_field_openingHours = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_get_field_openingHours'));
final _sdk_search_Details_get_field_categories = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_get_field_categories'));
final _sdk_search_Details_get_field_images = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_get_field_images'));
final _sdk_search_Details_get_field_editorials = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_get_field_editorials'));
final _sdk_search_Details_get_field_ratings = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_get_field_ratings'));
final _sdk_search_Details_get_field_references = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
...
Pointer<Void> sdk_search_Details_toFfi(Details value) {
  ...
  final _images_handle = heresdk_search_common_bindings_ListOf_sdk_search_WebImage_toFfi(value.images);
  final _editorials_handle = heresdk_search_common_bindings_ListOf_sdk_search_WebEditorial_toFfi(value.editorials);
  final _ratings_handle = heresdk_search_common_bindings_ListOf_sdk_search_WebRating_toFfi(value.ratings);
  final _references_handle = heresdk_search_common_bindings_ListOf_sdk_search_SupplierReference_toFfi(value.references);
  final _result = _sdk_search_Details_create_handle(_contacts_handle, _openingHours_handle, _categories_handle, _images_handle, _editorials_handle, _ratings_handle, _references_handle);
  ...
  heresdk_search_common_bindings_ListOf_sdk_search_SupplierReference_releaseFfiHandle(_references_handle);
  return _result;
}
...
Details sdk_search_Details_fromFfi(Pointer<Void> handle) {
  ...
  final _references_handle = _sdk_search_Details_get_field_references(handle);
  try {
    return Details(
      ...
      heresdk_search_common_bindings_ListOf_sdk_search_SupplierReference_fromFfi(_references_handle)
    );
  } finally {
    heresdk_search_common_bindings_ListOf_sdk_search_Contact_releaseFfiHandle(_contacts_handle);
    heresdk_search_common_bindings_ListOf_sdk_search_OpeningHours_releaseFfiHandle(_openingHours_handle);
...
final _sdk_search_Details_create_handle_nullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_create_handle_nullable'));
final _sdk_search_Details_release_handle_nullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_search_Details_release_handle_nullable'));
final _sdk_search_Details_get_value_nullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)

...
final _sdk_routing_Arrival_get_field_indoorLocation = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
...
Pointer<Void> sdk_routing_Arrival_toFfi(Arrival value) {
  ...
  final _result = _sdk_routing_Arrival_create_handle(_type_handle, _waypointIndex_handle, _originalCoordinates_handle, _mapMatchedCoordinates_handle, _chargeInKilowattHours_handle, _chargingStation_handle, _indoorLocation_handle);
...
Arrival sdk_routing_Arrival_fromFfi(Pointer<Void> handle) {
  ...
  final _indoorLocation_handle = _sdk_routing_Arrival_get_field_indoorLocation(handle);
  try {
    return Arrival(

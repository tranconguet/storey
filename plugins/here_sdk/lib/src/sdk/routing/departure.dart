...
final _sdk_routing_Departure_create_handle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
...
final _sdk_routing_Departure_release_handle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_routing_Departure_release_handle'));
final _sdk_routing_Departure_get_field_type = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
  >('here_sdk_sdk_routing_Departure_get_field_type'));
final _sdk_routing_Departure_get_field_waypointIndex = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_Departure_get_field_waypointIndex'));
final _sdk_routing_Departure_get_field_originalCoordinates = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_Departure_get_field_originalCoordinates'));
final _sdk_routing_Departure_get_field_mapMatchedCoordinates = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_Departure_get_field_mapMatchedCoordinates'));
final _sdk_routing_Departure_get_field_chargeInKilowattHours = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_Departure_get_field_chargeInKilowattHours'));
final _sdk_routing_Departure_get_field_chargingStation = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_Departure_get_field_chargingStation'));
final _sdk_routing_Departure_get_field_indoorLocation = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_Departure_get_field_indoorLocation'));

Pointer<Void> sdk_routing_Departure_toFfi(Departure value) {
  ...
  final _indoorLocation_handle = sdk_routing_IndoorLocationDataInternal_toFfi_nullable(value.internalindoorLocation);
  final _result = _sdk_routing_Departure_create_handle(_type_handle, _waypointIndex_handle, _originalCoordinates_handle, _mapMatchedCoordinates_handle, _chargeInKilowattHours_handle, _chargingStation_handle, _indoorLocation_handle);
  ...
  sdk_routing_IndoorLocationDataInternal_releaseFfiHandle_nullable(_indoorLocation_handle);
  return _result;
}

Departure sdk_routing_Departure_fromFfi(Pointer<Void> handle) {
  final _type_handle = _sdk_routing_Departure_get_field_type(handle);
  final _waypointIndex_handle = _sdk_routing_Departure_get_field_waypointIndex(handle);
  final _originalCoordinates_handle = _sdk_routing_Departure_get_field_originalCoordinates(handle);
  final _mapMatchedCoordinates_handle = _sdk_routing_Departure_get_field_mapMatchedCoordinates(handle);
  final _chargeInKilowattHours_handle = _sdk_routing_Departure_get_field_chargeInKilowattHours(handle);
  final _chargingStation_handle = _sdk_routing_Departure_get_field_chargingStation(handle);
  final _indoorLocation_handle = _sdk_routing_Departure_get_field_indoorLocation(handle);
  try {
    return Departure(
      ...
      sdk_routing_IndoorLocationDataInternal_fromFfi_nullable(_indoorLocation_handle)
    );
  } finally {
    sdk_routing_RoutePlaceType_releaseFfiHandle(_type_handle);
    Int_releaseFfiHandle_nullable(_waypointIndex_handle);
...
void sdk_routing_Departure_releaseFfiHandle(Pointer<Void> handle) => _sdk_routing_Departure_release_handle(handle);

// Nullable Departure

final _sdk_routing_Departure_create_handle_nullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_Departure_create_handle_nullable'));
final _sdk_routing_Departure_release_handle_nullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
  >('here_sdk_sdk_routing_Departure_release_handle_nullable'));
final _sdk_routing_Departure_get_value_nullable = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_Departure_get_value_nullable'));

Pointer<Void> sdk_routing_Departure_toFfi_nullable(Departure value) {
  if (value == null) return Pointer<Void>.fromAddress(0);
  final _handle = sdk_routing_Departure_toFfi(value);
  final result = _sdk_routing_Departure_create_handle_nullable(_handle);
  sdk_routing_Departure_releaseFfiHandle(_handle);
  return result;
}

Departure sdk_routing_Departure_fromFfi_nullable(Pointer<Void> handle) {
  if (handle.address == 0) return null;
  final _handle = _sdk_routing_Departure_get_value_nullable(handle);
  final result = sdk_routing_Departure_fromFfi(_handle);
  sdk_routing_Departure_releaseFfiHandle(_handle);
  return result;
}

void sdk_routing_Departure_releaseFfiHandle_nullable(Pointer<Void> handle) =>
  _sdk_routing_Departure_release_handle_nullable(handle);

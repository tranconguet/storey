...
final _sdk_routing_RoutePlace_get_field_name = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_RoutePlace_get_field_name'));
final _sdk_routing_RoutePlace_get_field_id = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_RoutePlace_get_field_id'));
final _sdk_routing_RoutePlace_get_field_platform = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
  >('here_sdk_sdk_routing_RoutePlace_get_field_platform'));
final _sdk_routing_RoutePlace_get_field_indoorLocation = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
...
Pointer<Void> sdk_routing_RoutePlace_toFfi(RoutePlace value) {
  ...
  final _platform_handle = String_toFfi_nullable(value.platform);
  final _indoorLocation_handle = sdk_routing_IndoorLocationDataInternal_toFfi_nullable(value.internalindoorLocation);
  final _result = _sdk_routing_RoutePlace_create_handle(_type_handle, _waypointIndex_handle, _originalCoordinates_handle, _mapMatchedCoordinates_handle, _chargeInKilowattHours_handle, _chargingStation_handle, _name_handle, _id_handle, _platform_handle, _indoorLocation_handle);
  ...
  String_releaseFfiHandle_nullable(_platform_handle);
...
RoutePlace sdk_routing_RoutePlace_fromFfi(Pointer<Void> handle) {
  ...
  final _name_handle = _sdk_routing_RoutePlace_get_field_name(handle);
  final _id_handle = _sdk_routing_RoutePlace_get_field_id(handle);
  final _platform_handle = _sdk_routing_RoutePlace_get_field_platform(handle);
  final _indoorLocation_handle = _sdk_routing_RoutePlace_get_field_indoorLocation(handle);
  try {
    return RoutePlace(
      ...
      String_fromFfi_nullable(_platform_handle), 

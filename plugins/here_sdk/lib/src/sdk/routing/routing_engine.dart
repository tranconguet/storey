...
class RoutingEngine$Impl implements RoutingEngine {
  ...
  @override
  calculateIsoline(Waypoint center, IsolineOptions isolineOptions, CalculateIsolineCallback callback) {
    final _calculateIsoline_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_routing_RoutingEngine_calculateIsoline__Waypoint_IsolineOptions_CalculateIsolineCallback'));
    final _center_handle = sdk_routing_Waypoint_toFfi(center);
    final _isolineOptions_handle = sdk_routing_IsolineOptions_toFfi(isolineOptions);
    final _callback_handle = sdk_routing_CalculateIsolineCallback_toFfi(callback);
    final _handle = this.handle;
    final __result_handle = _calculateIsoline_ffi(_handle, __lib.LibraryContext.isolateId, _center_handle, _isolineOptions_handle, _callback_handle);
    sdk_routing_Waypoint_releaseFfiHandle(_center_handle);
    sdk_routing_IsolineOptions_releaseFfiHandle(_isolineOptions_handle);
    sdk_routing_CalculateIsolineCallback_releaseFfiHandle(_callback_handle);
    try {
      return (__result_handle);
    } finally {
      (__result_handle);
  ...
  calculateScooterRoute(List<Waypoint> waypoints, ScooterOptions scooterOptions, CalculateRouteCallback callback) {
    final _calculateScooterRoute_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>), void Function(Pointer<Void>, int, Pointer<Void>, Pointer<Void>, Pointer<Void>)>('here_sdk_sdk_routing_RoutingInterface_calculateRoute__ListOf_1sdk_1routing_1Waypoint_ScooterOptions_CalculateRouteCallback'));
    final _waypoints_handle = heresdk_routing_bindings_ListOf_sdk_routing_Waypoint_toFfi(waypoints);
    final _scooterOptions_handle = sdk_routing_ScooterOptions_toFfi(scooterOptions);
    final _callback_handle = sdk_routing_CalculateRouteCallback_toFfi(callback);
    final _handle = this.handle;
    final __result_handle = _calculateScooterRoute_ffi(_handle, __lib.LibraryContext.isolateId, _waypoints_handle, _scooterOptions_handle, _callback_handle);
    heresdk_routing_bindings_ListOf_sdk_routing_Waypoint_releaseFfiHandle(_waypoints_handle);

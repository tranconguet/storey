...
class HereSdkPlugin() : HereSdkBasePlugin() {
    ...
    override fun onAttachedToActivity(@NonNull flutterPluginBinding: ActivityPluginBinding) {
        super.onAttachedToActivity(flutterPluginBinding)
    ...
    override fun onReattachedToActivityForConfigChanges(@NonNull flutterPluginBinding: ActivityPluginBinding) {
        super.onReattachedToActivityForConfigChanges(flutterPluginBinding)
